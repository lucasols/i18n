...
const translations = {
  ...
  'Saved': 'Saved',
  'You have no bookmarked conversations': 'You have no bookmarked conversations',
  'Channels': 'Channels',
...
const cases = [
  ...
  ['__formattedTimeDuration', (mod) =>
    mod.__formattedTimeDuration(durationObj)],
